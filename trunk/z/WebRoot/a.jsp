		...
		<div id="header">
			<div class="container">
				<div class="left_wrapper">
					<div id="site_name">
						<a href="./者也_files/者也.htm"><img alt="Logo"
								src="./者也_files/logo.png">
						</a>
					</div>
					<div id="add_ask">
						<input type="text" placeholder="搜索问题，话题，会员" autocomplete="off"
							class="ac_input">
						<a href="http://zheye.org/asks/new" >我要提问</a>
					</div>
			...
			<div id="report_page">
				...
				<form id="report_page_form" action="http://zheye.org/report.js"
					...
					<div class="acitons">
						...
						<a href="http://zheye.org/#" style="margin-left: 5px;"
							>关闭</a>
					</div>
				</form>
			</div>
